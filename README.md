...
**LiveHindiस्ट्रीट – Next.js Front Page**
<img width="1366" height="768" alt="Screenshot (529)" src="https://github.com/user-attachments/assets/38871ec4-5316-4b1f-af0a-3cb6125077cc" />
...
docs/design.md – Wireframe, layout rationale, data fetching justification, component + data explanations, challenges, improvements.
docs/testing.md – Required edge cases and manual checklist.
docs/ai-reflection.md – AI assistance log per assignment instructions.
Future Enhancements
